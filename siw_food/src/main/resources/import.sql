...
INSERT INTO ricetta (id, nome, cuoco_id, descrizione) VALUES(nextval('ricetta_seq'), 'Pasta fighissima', (SELECT id FROM cuoco WHERE nome='Goku' AND cognome='Fighissimo'), 'Pasta DAVVERO fighissima!')
INSERT INTO ricetta (id, nome, cuoco_id, descrizione) VALUES(nextval('ricetta_seq'), 'Carne vegetariana', (SELECT id FROM cuoco WHERE nome='Vegeta' AND cognome='Vegetariano'), 'Carne DAVVERO vegetariana!')
